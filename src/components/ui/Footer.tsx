...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 mt-20 pt-12 pb-16 border-t border-[color-mix(in_oklab,var(--g-ink)_10%,transparent)] max-w-6xl mx-auto px-4 sm:px-6">
      <div className="flex flex-col gap-4 text-xs text-(--ink-soft)">
        {/* Top row: main nav links */}
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <Link
              href="/about"
              className="hover:text-(--ink) underline underline-offset-4 font-medium transition"
            >
              {tNav('about')}
            </Link>
            <span>•</span>
          ...
          <div className="flex items-center gap-4">
            <MotionToggle />
            <span>•</span>
            <span className="font-(family-name:--font-zen-kaku)">
